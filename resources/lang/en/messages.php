...
return [
    ...
    'client_login_subtitle' => 'Place orders & manage your laundry services',
    'employee_login' => 'Employee Login',
    'employee_login_subtitle' => 'Order management & invoicing',
    'driver_login' => 'Driver Login',
    'driver_login_subtitle' => 'Manage your deliveries & pickups',
    'admin_login' => 'Admin Login',
    'admin_login_subtitle' => 'Full system access & administration',
    ...
    'period_day' => 'day',
    'period_day_plural' => 'days',
    'period_week' => 'week',
    'period_week_plural' => 'weeks',
    'period_month' => 'month',
    ...
    'period_help_text' => 'The period is how often this subscription renews and gets billed — e.g. "1 month" means the user is automatically charged and re-credited every month.',
    'subscription_billing_status' => 'Billing Status',
    'subscription_status_active' => 'Active',
    'subscription_status_failed_once' => 'Payment Failed (1 period)',
    'subscription_status_failed_multiple' => 'Payment Failed (2+ periods)',
    'subscription_status_none' => 'No Subscription',
    ...
    'failed_multiple_subscriptions' => 'Failed (2+ months)',
    'filter_all' => 'All',
    'consecutive_failures' => 'Consecutive Failures',
    'last_billed_at' => 'Last Billed',
    ...
    'order_status_pickup_scheduled' => 'Pickup Scheduled',
    'order_status_at_facility' => 'At Facility',
    'order_status_sorting' => 'Sorting',
    'order_status_washing' => 'Washing',
    ...
    'subscription_created_pending_payment' => 'Subscription created successfully. It will be activated once the user completes the KNET payment.',
    'you_owe' => 'You owe',
    ...
    'validation_user_exists' => 'The selected user does not exist.',
    'validation_driver_required' => 'Please select a driver when a delivery option is chosen.',
    'validation_driver_exists' => 'The selected driver does not exist.',
    'validation_province_required' => 'Please select a province for the delivery address.',
    'validation_city_required' => 'Please select a city for the delivery address.',
    'validation_street_required' => 'Please enter the street for the delivery address.',
    'validation_building_required' => 'Please enter the building for the delivery address.',
    'validation_floor_required' => 'Please enter the floor number for the delivery address.',
    'validation_floor_integer' => 'The floor number must be a whole number.',
    'validation_apartment_required' => 'Please enter the apartment number for the delivery address.',
    'validation_products_required' => 'Please add at least one product to the order.',
    'validation_product_required' => 'Please select a product in row :row.',
    'validation_product_exists' => 'The selected product in row :row does not exist.',
    'validation_service_required' => 'Please select a service in row :row.',
    'validation_service_exists' => 'The selected service in row :row does not exist.',
    'validation_quantity_required' => 'Please enter a quantity in row :row.',
    'validation_quantity_min' => 'Quantity in row :row must be at least 1.',
    'validation_order_status_required' => 'Please select an order status.',
    ...
    'go_to_order_desc' => 'Jump directly to an order by its ID',
    'order_id_placeholder' => 'Enter order ID',
    'order_not_found' => 'Order #:id was not found.',
    'go' => 'Go',
    'go_to_user' => 'Go to User',
    'go_to_user_desc' => 'Jump directly to a user by their ID',
    ...
    'monthly_income_chart' => 'Monthly Income Chart (Last 12 Months)',
    'income_by_status' => 'Income Breakdown by Status',
    'order_count' => 'Order Count',
    'total_amount' => 'Total Amount',
    'percentage_share' => 'Share',
    'top_orders' => 'Top Orders by Value',
    'back_to_dashboard' => 'Back to Dashboard',
    'no_income_data' => 'No income data available yet.',
    'income' => 'Income',
    ...
    'search_invoices' => 'Search by Order ID or Client Name',
    'items_count' => 'Items',
    'subtotal' => 'Subtotal',
    ...
    'subscription_renewal_success' => 'Your subscription was renewed! :amount KWD charged, new balance: :balance',
    'subscription_renewal_failed' => 'Your subscription renewal failed due to insufficient balance. Please top up your balance. Current balance: :balance',
    'subscription_initial_payment_link' => 'A subscription has been created for your account. Please pay :amount KWD via this link to activate it: :payment_url',
    'subscription_renewal_payment_link' => 'Your subscription renewal of :amount KWD could not be charged from your wallet. Please pay via this link to keep your subscription active: :payment_url',
    'subscription_suspended' => 'Your subscription has been suspended due to :amount KWD unpaid for multiple periods. Please contact us to reactivate.',
    ...
    'points_price_help' => 'Leave empty if this service cannot be paid with points.',
    ...
    'edit_points_package' => 'Edit Points Package',
    'buy_points' => 'Buy Points',
    'assign_points' => 'Assign Points',
    'points_purchase_history' => 'Points Purchase History',
    'points_added' => 'Points added! Your new points balance: :points_balance pts',
    'my_points' => 'My Points',
    'pay_with_money' => 'Pay with Money (KWD)',
    'pay_with_points' => 'Pay with Points',
    'pay_with_knet' => 'Pay with KNET',
    'knet_sandbox' => 'Sandbox',
    'knet_payment_initiation_failed' => 'Failed to initiate KNET payment. Please try again.',
    'retry_order_payment' => 'Retry Payment',
    'not_paid' => 'Not Paid',
    'payment_status' => 'Payment Status',
    'pay_now' => 'Pay Now',
    'order_paid_successfully' => 'Payment processed successfully.',
    ...
    'amount' => 'Amount',
    'balance_settled_successfully' => 'Balance settled successfully.',
    'no_outstanding_balance' => 'This user has no outstanding balance.',
    ...
    'payment_link_description' => 'Send this link to the customer to pay via KNET.',
    'points_used' => 'Points Used',
    'package_price_kwd' => 'Package Price (KWD)',
    'package_points' => 'Package Points',
    'package_name' => 'Package Name',
    'insufficient_points' => 'Insufficient points balance to complete this order.',
    'points_assigned_successfully' => 'Points assigned successfully to :user (:points pts added).',
    ...
    'optional' => 'Optional',
    'product_no_points_price_warning' => 'One or more selected product services have no points price configured. Please set a points price for the service before paying with points.',
