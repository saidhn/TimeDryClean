            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('client.register') }}">
                        ...
                        <div class="mb-3">
                            <label for="address_id" class="form-label">{{ __('Address') }}</label>
                            <select name="address_id" id="address_id" class="form-control @error('address_id') is-invalid @enderror" required>
                        ...
                        <div class="mt-2">
                            <a class="btn btn-link" href="{{ route('client.login') }}">
                                {{ __('Login') }}
                            </a>
                        </div>
                    </form>
