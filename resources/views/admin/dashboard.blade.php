...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <p class="mb-0">{{ __('messages.hello') }}, {{ Auth::guard('admin')->user()->name }}!</p>
    </div>
    ...
    <div class="row g-4">
        ...
        <!-- Invoice Data Card -->
        <div class="col-md-4">
            <a href="{{ route('admin.invoice-data') }}" class="text-decoration-none">
                <div class="card h-100 border-0 shadow-sm dashboard-card">
                    <div class="card-body text-center py-4">
                        <div class="mb-3">
        ...
        <!-- Total Income Card -->
        <div class="col-md-4">
            <a href="{{ route('admin.total-income') }}" class="text-decoration-none">
                <div class="card h-100 border-0 shadow-sm dashboard-card">
                    <div class="card-body text-center py-4">
                        <div class="mb-3">
